...
import static com.cdsoftware.lirionizer.test.util.RandomTestUtil.*;
import static com.cdsoftware.lirionizer.test.util.ReflectionTestUtil.*;
...
class KeyValueLoggerTest {
	...
	void shouldPrintClassFromClass() {
		...
		verifyStringLog(Level.INFO, "class=\"com.cdsoftware.lirionizer.util.KeyValueLogger\"");
	}
	...
	void shouldPrintPackageFromClass() {
		...
		verifyStringLog(Level.INFO, "package=\"com.cdsoftware.lirionizer.util\"");
	}
