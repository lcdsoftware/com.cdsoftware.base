...
call mvn validate -Didempiere.target=com.cdsoftware.lirionizer.p2.targetplatform %DEBUG_MODE%
call mvn verify -Didempiere.target=com.cdsoftware.lirionizer.p2.targetplatform %DEBUG_MODE%
