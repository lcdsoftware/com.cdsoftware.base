...
- New callout
    * Name: CName
    * Package: com.cdsoftware.lirionizer.callout
    * Example: com.cdsoftware.lirionizer.callout.CStringFormat

- New process
    * Name: PName
    * Package: com.cdsoftware.lirionizer.process
    * Example: com.cdsoftware.lirionizer.process.PGenerateWithholding

- New form
    * Name: FName
    * Package: com.cdsoftware.lirionizer.form
    * Example: com.cdsoftware.lirionizer.form.FMultiPayment

- New event
    * Name: EName
    * Package: com.cdsoftware.lirionizer.event
    * Example: com.cdsoftware.lirionizer.event.EAfterCompleteInvoice

- New model (extends class X)
    * Name: MName
    * Package: com.cdsoftware.lirionizer.model
    * Example: com.cdsoftware.lirionizer.model.MTableExample
...
- New callout
    * Create callout in package `com.cdsoftware.lirionizer.callout`, extends from `CustomCallout`
    * Annotate it with the `@Callout` annotation at class level

- New process
    * Create process in package `com.cdsoftware.lirionizer.process`, extends from `CustomProcess`
    * Annotate it with the `@Process` annotation at class level

- New form
    * Create form in package `com.cdsoftware.lirionizer.form`, extends from `CustomForm`
    * Annotate it with the `@Form` annotation at class level

- New event
    * Create event in package `com.cdsoftware.lirionizer.event`, extends from `CustomEvent`
    * Annotate it with the `@EventTopicDelegate` annotation at class level

- New model (extends form class X)
    * Create model in package `com.cdsoftware.lirionizer.model`, extends class `X`. Example: `X_TL_TableExample -> MTableExample`
